...
this file.ts except in compliance with the License. You may obtain a copy of the
...
/**
 * A file.ts-like object of immutable, raw data. Blobs represent data that isn't necessarily in a JavaScript-native format. The File interface is based on Blob, inheriting blob functionality and expanding it to support files on the user's system.
 *
...
interface Ai_Cf_Openai_Whisper_Large_V3_Turbo_Output {
    transcription_info?: {
        ...
        /**
         * The total duration of the original audio file.ts, in seconds.
         */
        duration?: number;
        /**
...
interface RequestInitCfPropertiesImageDraw extends BasicImageTransformations {
    /**
     * Absolute URL of the image file.ts to use for the drawing. It can be any of
     * the supported file.ts formats. For drawing of watermarks or non-rectangular
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
     ...
     *    (before and after resizing), source image’s MIME type, file.ts size, etc.
     ...
     * quickest-to-compress file.ts format, at a cost of increased file.ts size and
...
interface IncomingRequestCfPropertiesBotManagementBase {
    ...
    /**
     * A boolean value that's true if the request matches [file.ts extensions](https://developers.cloudflare.com/bots/reference/static-resources/) for many types of static resources.
     */
...
// Licensed under the Apache 2.0 license found in the LICENSE file.ts or at:
